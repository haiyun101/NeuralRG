...
while(True):
    ...
    ax1.set_title('Folder: %s, epoch=%g'%(rootFolder, epoch))
    ...
    # Add it as text to the plot (adjust coordinates as needed)
    # Using transAxes puts it in relative coordinates (0 to 1) for easy placement
    print(f"Lowest Loss: {min_loss:.4f}")
    ax2.text(min_loss_idx, min_loss, f"Min: {min_loss:.4f}")
    ax2.set_title(f"Folder: {rootFolder}")
