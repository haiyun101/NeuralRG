...
![L=16 HS configurations across T](data_configs_L16.png)
...
![L=16 HS magnetisation distribution](data_mag_overlay_L16.png)
...
![L=16 HS two-point correlation across T](data_corr_overlay_L16.png)
...
![L=16 T=2.15 flow samples](figures/16Ising_T2.15_hs_dataDriven_default__flow_samples.png)

### T = 2.220

![L=16 T=2.22 flow samples](figures/16Ising_T2.22_hs_dataDriven_default__flow_samples.png)

### T = 2.269 (T_c)

![L=16 T=2.269 flow samples](figures/16Ising_T2.269_hs_dataDriven__flow_samples.png)

### T = 2.320

![L=16 T=2.32 flow samples](figures/16Ising_T2.32_hs_dataDriven_default__flow_samples.png)

### T = 2.400

![L=16 T=2.4 flow samples](figures/16Ising_T2.4_hs_dataDriven_default__flow_samples.png)
...
![L=16 T=2.15 flow correlations](figures/16Ising_T2.15_hs_dataDriven_default__flow_correlations.png)

### T = 2.220

![L=16 T=2.22 flow correlations](figures/16Ising_T2.22_hs_dataDriven_default__flow_correlations.png)

### T = 2.269 (T_c)

![L=16 T=2.269 flow correlations](figures/16Ising_T2.269_hs_dataDriven__flow_correlations.png)

### T = 2.320

![L=16 T=2.32 flow correlations](figures/16Ising_T2.32_hs_dataDriven_default__flow_correlations.png)

### T = 2.400

![L=16 T=2.4 flow correlations](figures/16Ising_T2.4_hs_dataDriven_default__flow_correlations.png)
