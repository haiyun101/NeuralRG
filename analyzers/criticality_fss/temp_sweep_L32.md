...
![L=32 HS configurations across T](figures/data_configs_L32.png)
...
![L=32 HS magnetisation distribution](figures/data_mag_overlay_L32.png)
...
![L=32 HS two-point correlation across T](figures/data_corr_overlay_L32.png)
...
![L=32 T=2.15 flow samples](../concise_reports/figures/32Ising_T2.15_hs_dataDriven__flow_samples.png)

### T = 2.220

![L=32 T=2.22 flow samples](../concise_reports/figures/32Ising_T2.22_hs_dataDriven__flow_samples.png)

### T = 2.269 (T_c)

![L=32 T=2.269 flow samples](../concise_reports/figures/32Ising_T2.269_hs_dataDriven__flow_samples.png)

### T = 2.320

![L=32 T=2.32 flow samples](../concise_reports/figures/32Ising_T2.32_hs_dataDriven__flow_samples.png)

### T = 2.400

![L=32 T=2.4 flow samples](../concise_reports/figures/32Ising_T2.4_hs_dataDriven__flow_samples.png)
...
![L=32 T=2.15 flow correlations](../concise_reports/figures/32Ising_T2.15_hs_dataDriven__flow_correlations.png)

### T = 2.220

![L=32 T=2.22 flow correlations](../concise_reports/figures/32Ising_T2.22_hs_dataDriven__flow_correlations.png)

### T = 2.269 (T_c)

![L=32 T=2.269 flow correlations](../concise_reports/figures/32Ising_T2.269_hs_dataDriven__flow_correlations.png)

### T = 2.320

![L=32 T=2.32 flow correlations](../concise_reports/figures/32Ising_T2.32_hs_dataDriven__flow_correlations.png)

### T = 2.400

![L=32 T=2.4 flow correlations](../concise_reports/figures/32Ising_T2.4_hs_dataDriven__flow_correlations.png)
