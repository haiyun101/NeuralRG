...
![hs_dataDriven flow samples](../data/8Ising_T2.269_hs_dataDriven/flow_samples.png)

### sym

![sym flow samples](../data/8Ising_T2.269_sym/flow_samples.png)
...
![hs_dataDriven flow correlations](../data/8Ising_T2.269_hs_dataDriven/flow_correlations.png)

### sym

![sym flow correlations](../data/8Ising_T2.269_sym/flow_correlations.png)
