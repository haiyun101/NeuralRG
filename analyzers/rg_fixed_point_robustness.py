...
def main():
    ...
    write_csv(v1, v2, v3, os.path.join(args.outdir,
              "rg_fixed_point_robustness.csv"))
    plot_v1(v1, os.path.join(args.outdir,
            "rg_fixed_point_robustness_v1_global.png"))
    plot_v2(v2, os.path.join(args.outdir,
            "rg_fixed_point_robustness_v2_chain.png"))
    plot_v3(v3, os.path.join(args.outdir,
            "rg_fixed_point_robustness_v3_identity.png"))
