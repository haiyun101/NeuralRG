...
#SBATCH --output=./logs/L128_MERAonly_%j.out
#SBATCH --error=./logs/L128_MERAonly_%j.err

# ABLATION 1: Transfer MERA blocks ONLY from L=64 champion.
# HCG per-scale CNNs stay at fresh init.
# Compare vs both-transfer (1801027) + fresh-init (1801028) to isolate
# how much physics is in MERA vs CNN.
...
python -u main.py \
    ...
    -folder ./data/L128_T2.269_MERAonly_from_L64 \
    -dataDriven -skipHMC \
