...
#SBATCH --mem=8G
#SBATCH --time=8:00:00
#SBATCH --output=./logs/L8_hs_%j.out
#SBATCH --error=./logs/L8_hs_%j.err
...
L=8
EPOCHS=30000
DISC_PT="data/mcmc_data/mcmc_wolff_L8_T2.269_N200000.pt"
HS_PT="data/mcmc_data/hs_L8_T${T}_N200000.pt"
FOLDER="./data/8Ising_T2.269_hs_dataDriven"

echo "=========================================="
echo "L=8 HS Data-Driven Training"
